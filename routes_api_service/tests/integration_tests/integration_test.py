...
def test_both_ports():
    ...
    expected = [
        {"average_price": "1991.6666666666666667", "day": "2016-01-01"},
...
def test_dest_region():
    ...
    actual = orjson.loads(result.text)
    expected = [
        {"average_price": "1702.0921052631578947", "day": "2016-01-01"},
...
def test_origin_region():
    ...
    actual = orjson.loads(result.text)
    expected = [
        {"average_price": "1111.3888888888888889", "day": "2016-01-20"},
...
def test_both_region():
    ...
    actual = orjson.loads(result.text)
    expected = [
        {"average_price": "1365.6586021505376344", "day": "2016-01-20"},
